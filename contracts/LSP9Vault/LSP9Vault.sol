 ...
 */
contract LSP9Vault is ERC725, LSP14Ownable2Step, LSP17Extendable, ILSP1UniversalReceiver {
    ...
    function transferOwnership(
        address newOwner
    ) public virtual override(LSP14Ownable2Step, Ownable) onlyOwner {
        LSP14Ownable2Step._setPendingOwner(newOwner);
     ...
     * @inheritdoc LSP14Ownable2Step
     */
    function renounceOwnership() public virtual override(LSP14Ownable2Step, Ownable) onlyOwner {
