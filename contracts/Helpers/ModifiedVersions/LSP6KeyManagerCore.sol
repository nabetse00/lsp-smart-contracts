 ...
 */
abstract contract LSP6KeyManagerCoreV2 is ILSP6KeyManager, ERC165 {
    using LSP2Utils for ERC725YV2;
    using LSP6Utils for ERC725V2;
    using Address for address;
    using ECDSA for bytes32;
    using ERC165Checker for address;

    ERC725V2 public account;
        ...
        view
    {
        ...
        if (erc725Function == hex"14a6e293") {
    ...
    function _verifyCanSetPermissions(
        ...
        if (bytes32(ERC725YV2(account).getData(_key)) == bytes32(0)) {
    ...
    function _verifyAllowedERC725YKeys(
        ...
        bytes memory allowedERC725YKeysEncoded = ERC725YV2(account).getData(
    ...
    function _verifyAllowedStandard(address _from, address _to) internal view {
        bytes memory allowedStandards = ERC725YV2(account).getData(
            LSP2Utils.generateBytes20MappingWithGroupingKey(
